  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-RWHY35A2.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet2(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-HGJCGLDY.js"));
